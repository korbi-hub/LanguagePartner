                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          context
                              .read<ChatBloc>()
                              .add(GetTranslation(widget.message, widget.botId, UserId.userId,));
                      ...
                      GestureDetector(
                        onTap: () {
                          context
                              .read<ChatBloc>()
                              .add(GetExplanation(widget.message, widget.botId, UserId.userId,));
                          Navigator.of(context).pop();
                        },
                        child: Text(
                          'explain grammar',
                      ...
                      GestureDetector(
                        onTap: () async {
                          Navigator.of(context).pop();
                          context.read<VocabularyBloc>().add(AddWords(widget.message, UserId.userId));
                          const snackBar = SnackBar(content: Text('saved vocabulary'));
